...
public class TirageDeCarteTest {
    ...
    void should_return_all_card_from_clubs() {
        String listClubs = new JeuDeCarte().getClubs().toString().replaceAll("\\[|]| ,", "").trim();
    ...
    void should_return_all_card_from_spades() {
        String listClubs = new JeuDeCarte().getSpades().toString().replaceAll("\\[|]| ,", "").trim();
        assertAll("Jeu de carte pour clubs",
    ...
    void should_return_all_card_from_diamonds() {
        String listClubs = new JeuDeCarte().getDiamonds().toString().replaceAll("\\[|]| ,", "").trim();
        assertAll("Jeu de carte pour clubs",
    ...
    void should_return_all_card_from_hearts() {
        String listClubs = new JeuDeCarte().getHearts().toString().replaceAll("\\[|]| ,", "").trim();
        assertAll("Jeu de carte pour clubs",
